...
[One or two sentences: product, tech stack, and the outcome you want.]

## Scope

- Repos / paths: [e.g. monorepo root, service name]
- In scope: [files, features, migrations]
...
```markdown
I'm building [X] with [Y]. I'll need to [Z]. What skills should I enable first?
```
